...
def create_test_data():
    ...
    # 创建分类
    categories = [
        {'name': 'Action Games', 'slug': 'action', 'description': 'Fast-paced action games'},
        {'name': 'Puzzle Games', 'slug': 'puzzle', 'description': 'Brain-teasing puzzle games'},
        {'name': 'Adventure Games', 'slug': 'adventure', 'description': 'Exciting adventure games'},
        {'name': 'Sports Games', 'slug': 'sports', 'description': 'Sports and racing games'},
    ]
